...
(() => {
    ...
    class PathFollower {
        ...
        selectPointWithSameDirection (point1, point2) {
            let score1 = (point1.xPos === this.lastMove.xPos ? 1 : 0) + 
                         (point1.yPos === this.lastMove.yPos ? 1 : 0),

                score2 = (point2.xPos === this.lastMove.xPos ? 1 : 0) + 
                         (point2.yPos === this.lastMove.yPos ? 1 : 0);
